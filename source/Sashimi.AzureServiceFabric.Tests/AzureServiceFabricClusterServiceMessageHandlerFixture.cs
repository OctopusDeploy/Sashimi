...
namespace Sashimi.AzureServiceFabric.Tests
{
    public class AzureServiceFabricClusterServiceMessageHandlerFixture
    {
        ...
        {
            Action action = () => serviceMessageHandler.BuildEndpoint(null, new VariableDictionary(), _ => null, _ => null, null, null);
        ...
        {
            Action action = () => serviceMessageHandler.BuildEndpoint(new Dictionary<string, string>(), null, _ => null, _ => null, null, null);
